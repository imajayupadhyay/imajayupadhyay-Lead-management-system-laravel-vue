<template>
  <Head title="Edit Task - Counselor" />
        ...
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div class="bg-white rounded-xl shadow-lg p-8">
            <form @submit.prevent="submitForm">
              ...
              <!-- Completed At Info -->
              <div v-if="task.completed_at" class="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                <p class="text-sm text-green-800">
                  <strong>Completed on:</strong> {{ formatDateTime(task.completed_at) }}
                </p>
              </div>
...
const submitForm = () => {
  form.put(route('counselor.tasks.update', props.task.id), {
    preserveScroll: true
  });
};
