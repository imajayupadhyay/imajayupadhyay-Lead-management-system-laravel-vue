          ...
          <div class="relative">
            ...
            >
              ...
              <div class="hidden sm:block text-left">
                ...
                <p class="text-xs text-gray-500">Counselor</p>
              </div>
...
const currentPageTitle = computed(() => {
  ...
  if (url.includes('/counselor/dashboard')) return 'Dashboard'
  if (url.includes('/counselor/leads')) return 'Leads'
  if (url.includes('/counselor/reports')) return 'Reports'
  if (url.includes('/counselor/settings')) return 'Settings'
  return 'Dashboard'
})

const currentPageSubtitle = computed(() => {
  const url = window.location.pathname
  if (url.includes('/counselor/dashboard')) return 'Overview of your assigned leads'
  if (url.includes('/counselor/leads')) return 'Manage and track your leads'
  if (url.includes('/counselor/reports')) return 'View your performance reports'
  if (url.includes('/counselor/settings')) return 'Your account settings'
  return 'Welcome to your counselor panel'
})
