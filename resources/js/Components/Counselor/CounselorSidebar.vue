      ...
      <div class="flex flex-col flex-grow bg-gradient-to-b from-navy-900 to-navy-800 shadow-xl w-64">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
          ...
          <a
            ...
            class="sidebar-item"
            :class="{ 'active': isActiveRoute('/counselor/leads') }"
          >
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <!-- Follow-ups -->
          <a
            href="/counselor/follow-ups"
            class="sidebar-item"
            :class="{ 'active': isActiveRoute('/counselor/follow-ups') }"
          >
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a
            ...
            class="sidebar-item"
            :class="{ 'active': isActiveRoute('/counselor/tasks') }"
          >
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <!-- My Revenues -->
          <a
            href="/counselor/revenues"
            class="sidebar-item"
            :class="{ 'active': isActiveRoute('/counselor/revenues') }"
          >
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
