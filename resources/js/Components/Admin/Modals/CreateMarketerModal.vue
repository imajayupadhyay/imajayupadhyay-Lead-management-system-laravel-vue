        ...
        <form @submit.prevent="submit" class="bg-white">
          ...
          <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-6">
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                ...
                <div class="ml-4">
                  <h3 class="text-xl font-bold text-white">Add New Marketer</h3>
                  <p class="text-blue-100 text-sm">Create a new marketing team member account</p>
                </div>
              </div>
              <button
                type="button"
          ...
          <div class="flex justify-end space-x-3 px-6 py-4 bg-gray-50 border-t border-gray-200">
            ...
            >
              ...
              <span v-if="form.processing">Creating Marketer...</span>
              <span v-else>Create Marketer</span>
            </button>
          </div>
        </form>
      </div>
...
const emit = defineEmits(['close', 'marketerCreated'])
...
const submit = () => {
  form.post(route('admin.marketers.store'), {
    onSuccess: () => {
      emit('marketerCreated')
    },
    onError: () => {
