        ...
        <form @submit.prevent="submit" class="bg-white">
          ...
          <div class="bg-gradient-to-r from-emerald-600 to-emerald-700 px-6 py-6">
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                ...
                <div class="ml-4">
                  <h3 class="text-xl font-bold text-white">Edit Counselor</h3>
                  <p class="text-emerald-100 text-sm">Update counselor information and settings</p>
                </div>
              </div>
              <button
                type="button"
          ...
          <div class="px-6 py-6 space-y-6">
            ...
            <div class="bg-gradient-to-br from-emerald-50 to-green-50 rounded-xl p-6 border border-emerald-200">
              <h4 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                ...
                Update Counselor Responsibilities
              </h4>
          ...
          <div class="flex justify-end space-x-3 px-6 py-4 bg-gray-50 border-t border-gray-200">
            ...
            >
              ...
              <span v-if="form.processing">Updating Counselor...</span>
              <span v-else>Update Counselor</span>
            </button>
          </div>
        </form>
      </div>
...
const emit = defineEmits(['close', 'counselorUpdated'])
...
watch(() => props.counselor, (newCounselor) => {
  if (newCounselor) {
    form.name = newCounselor.name || ''
    form.email = newCounselor.email || ''
    form.phone = newCounselor.phone || ''
    form.is_active = newCounselor.is_active !== undefined ? newCounselor.is_active : true
  }
}, { immediate: true })
...
const submit = () => {
  ...
  form.put(route('admin.counselors.update', props.counselor.id), {
    onSuccess: () => {
      emit('counselorUpdated')
    },
    onError: () => {
