        ...
        <form @submit.prevent="submit" class="bg-white">
          ...
          <div class="bg-gradient-to-r from-emerald-600 to-emerald-700 px-6 py-6">
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                ...
                <div class="ml-4">
                  <h3 class="text-xl font-bold text-white">Edit Faculty</h3>
                  <p class="text-emerald-100 text-sm">Update faculty information and settings</p>
                </div>
              </div>
              <button
                type="button"
          ...
          <div class="px-6 py-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <!-- Subject -->
              <div>
                <label for="edit_subject" class="block text-sm font-semibold text-gray-700 mb-2">
            ...
            <div class="bg-gradient-to-br from-emerald-50 to-green-50 rounded-xl p-6 border border-emerald-200">
              <h4 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                ...
                Update Faculty Responsibilities
              </h4>
          ...
          <div class="flex justify-end space-x-3 px-6 py-4 bg-gray-50 border-t border-gray-200">
            ...
            >
              ...
              <span v-if="form.processing">Updating Faculty...</span>
              <span v-else>Update Faculty</span>
            </button>
          </div>
        </form>
      </div>
...
const emit = defineEmits(['close', 'facultyUpdated'])
...
watch(() => props.faculty, (newFaculty) => {
  if (newFaculty) {
    form.name = newFaculty.name || ''
    form.subject = newFaculty.subject || ''
    form.email = newFaculty.email || ''
    form.phone = newFaculty.phone || ''
    form.is_active = newFaculty.is_active !== undefined ? newFaculty.is_active : true
  }
}, { immediate: true })
...
const submit = () => {
  ...
  form.put(route('admin.faculty.update', props.faculty.id), {
    onSuccess: () => {
      emit('facultyUpdated')
    },
    onError: () => {
